...
private final RangedBowAttackGoal<HunterEntityAbstract> bowGoal = new RangedBowAttackGoal<>(this, 1.0D, 20, 15.0F);
   ...
   protected void registerGoals() {
	...
	public static AttributeModifierMap.MutableAttribute hunterAttributes() {
   ...
   protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
	  ...
	  this.getItemStackFromSlot(EquipmentSlotType.MAINHAND).setDisplayName(new TranslationTextComponent("equipment.huntermod.hunter_bow").func_240699_a_(TextFormatting.GREEN));
   }
